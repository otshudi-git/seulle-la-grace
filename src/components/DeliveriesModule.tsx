...
import { Truck, Package, CheckCircle, Clock, MapPin, User, X, Printer } from 'lucide-react';
...
export default function DeliveriesModule({ profile }: DeliveriesModuleProps) {
  ...
  const handlePrintLivraison = async (commande: Commande) => {
    try {
      ...
      const data = {
        numero: `LIV-${commande.numero_commande}`,
        ...
        livreur: commande.livreur?.nom || 'Non assigné',
      ...
      alert('Erreur lors de la préparation du bon de livraison');
    }
  };
              ...
              <div className="flex flex-col space-y-2">
                ...
                {commande.statut_livraison === 'EN_COURS' && (
                  <>
                    ...
                    <button
                      onClick={() => handlePrintLivraison(commande)}
